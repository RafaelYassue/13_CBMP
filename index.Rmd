...
.pull-left[
.incremental[
- **Increase selection accuracy** (improves \(r_{a}\) in the Breeder’s Equation)
- **Early selection** via indirect selection & genetic correlations
- **Early detection** of diseases/stresses before visible symptoms
- **Use of secondary traits** correlated with the main trait
- **Multi-trait prediction** (primary + secondary traits)
- **Integration with genomic selection** (GS + Phenomics = ↑ genetic gain)
- **Large-scale G×E studies**
]
]

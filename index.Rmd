---
title: "From Pixel to Insight: How High-Throughput Phenotyping Increases Genetic Gain"
author:  
...
| **How Phenomics Increases Genetic Gain** | **Effect on Genetic Gain** |
| :--------------------------------------- | :-------------------------- |
| Reduces experimental error               | ↑ Heritability → ↑ Accuracy |
| Enables repeated temporal measurements   | ↑ Precision of estimates    |
| Increases the number of plants measured  | ↑ Statistical robustness and ↑ genetic variance |
| Early selection                          | Genetic correlation between traits (e.g., root angle ↔ resilience) or early evaluation (e.g., disease resistance) |

---
class: animate__animated, animate__fadeIn

# Phenomics as a New Tool for Genetic Gain

- **Increase selection accuracy** (improves \(r_a\) in the Breeder’s Equation)

--

- **Early selection** of promising plants through indirect selection and genetic correlations

--

- **Early detection of diseases and stresses** before visible symptoms
...
- **Multi-trait prediction** combining primary and secondary traits

--

- **Integration with genomic selection** (GS + Phenomics = ↑ genetic gain)

--

- **Large-scale genotype × environment (G×E) studies**

--

- **Lower cost per data point** compared to manual phenotyping
...
- **Low-cost platforms** allow large-scale data collection
...
# Factors Influencing Accuracy, Applications, and Limitations of the Methodology

...
1. Fenômica e o Ganho Genético
2. Fenômica vs Genômica  
3. Estudos de Caso 
4. Aplicações, Limitações e Desafios
...
| Seleção precoce              | Correlação genética entre traits (ex.: angulação de raiz vs rusticidade) ou avaliação precoce (ex.: resistência a doenças) |
...
- **Seleção precoce** de plantas promissoras por seleção indireta e correlação genética entre traits
...
<table style="width:100%; border-collapse: collapse;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid #ddd; padding: 6px;">Variância fenotípica; pode incluir efeitos ambientais e superestimação da acurácia em CV e validação</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border: 1px solid #ddd; padding: 6px;">Predição apenas de traits conhecidos</td>
      <td style="border: 1px solid #ddd; padding: 6px;">Inferência de novos traits fisiológicos e estruturais</td>
    </tr>
    <tr>
...
```
<p style="font-family: times, serif; font-size:11pt; font-style:italic">
Figura. Diversas tentativas de montagem de ortomosaico e junção (stitching de imagens) com imagens termais.
</p>
---
class: animate__animated, animate__fadeIn
...
| **Experiência do Usuário**       | Conhecimento sobre operação e interpretação influencia na confiabilidade   |
...
| **Escalabilidade**         | Dificuldade em escalar HTP para grandes áreas ou múltiplas espécies | Garantir relevância biológica em larga escala e em diferentes ecossistemas |
...
- Fenômica amplia o ganho genético ao aumentar acurácia e reduzir custos  

- Tecnologias acessíveis permitem uso em larga escala, mesmo com orçamento restrito  

- Integração com genômica é o futuro: mais robustez, mais eficiência  

- Estratégias de melhoramento para maximizar a acurácia dos modelos de fenômica

- Multi-ômica → chave para próxima geração de melhoramento
